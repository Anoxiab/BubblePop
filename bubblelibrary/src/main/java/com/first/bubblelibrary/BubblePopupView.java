package com.first.bubblelibrary;
    ...
    public void showPopupListWindow(View anchorView, int contextPosition, float rawX, float rawY,
        ...
        if (mIsShowTouchLocation) {
            ...
            if (mReversalHeight > rawY) {
                mIsShowBottom = true;
                showPopupListWindow(mAnchorView.getWidth() / 2f - location[0], mAnchorView.getHeight());
            } else {
                mIsShowBottom = false;
                showPopupListWindow(mAnchorView.getWidth() / 2f - location[0], 0);
            }
        }
    }
